...
console.log('Setting up BrewAndBean tables...');
...
('Mocha', 'Espresso with chocolate syrup, steamed milk, and whipped cream', 5.25, 'Espresso', 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=300&h=300&fit=crop'),
...
('Frappuccino', 'Blended coffee drink with ice, milk, and flavoring', 5.50, 'Cold Coffee', 'https://images.unsplash.com/photo-1517701604599-bb29b565090a?w=300&h=300&fit=crop'),
('French Press', 'Full-bodied coffee brewed using the French press method', 4.75, 'Brewed Coffee', 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=300&h=300&fit=crop'),
('Pour Over', 'Hand-crafted coffee using the pour-over method', 4.50, 'Brewed Coffee', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=300&h=300&fit=crop'),
('Drip Coffee', 'Classic drip-brewed coffee, freshly made', 2.75, 'Brewed Coffee', 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?w=300&h=300&fit=crop')
`;
...
async function setupDatabase() {
  try {
    ...
    await connection.promise().execute(createProductsTable);
    console.log('✅ Products table created');

    console.log('Creating orders table...');
    await connection.promise().execute(createOrdersTable);
    console.log('✅ Orders table created');

    console.log('Creating order_items table...');
    await connection.promise().execute(createOrderItemsTable);
    console.log('✅ Order items table created');

    console.log('Inserting sample products...');
    await connection.promise().execute(insertProducts);
    console.log('✅ Sample products inserted');

    console.log('\n🎉 Database setup completed successfully!');
    console.log('📊 Database: brewandbean');
    console.log('📋 Tables: products, orders, order_items');
    console.log('☕ Products: 12 coffee items');
